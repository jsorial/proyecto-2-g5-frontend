      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-gray-600">&copy; {new Date().getFullYear()} CEM Salud Mental. Todos los derechos reservados.</p>
            <p className="text-gray-500 text-sm">Desarrollado con ❤️ para mejorar la salud mental.</p>
          </div>
          ...
          <div className="flex space-x-6">
            ...
            <Link to="/consentimiento" className="text-gray-600 hover:text-green-600 transition">
              Test Psicométrico
            </Link>
            <Link to="/recursos" className="text-gray-600 hover:text-green-600 transition">
              Recursos
            </Link>
            <Link to="/perfil" className="text-gray-600 hover:text-green-600 transition">
              Perfil
            </Link>
          </div>
        </div>
        ...
        <div className="mt-4 flex justify-center space-x-6">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-600 transition">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-600 transition">
